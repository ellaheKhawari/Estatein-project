...
export const PropertyCard = ({property, allProperties, index,}: { property: PropertyProps; allProperties: PropertyProps[]; index: number; }) => {
            ...
            <div className="bg-bg border border-border rounded-xl overflow-hidden flex flex-col h-full p-7">
                ...
                <div className="pt-3 flex flex-col flex-1 ">
                    <div className="mb-3">
                        ...
                        <button
                            className=" text-sm md:text-base underline transition-colors"
                    ...
                    <div className="flex flex-wrap md:flex-nowrap gap-2 ">
                        <span
                            className="flex items-center gap-1 bg-bg2 text-xs border border-border rounded-xl px-2 py-2">
                ...
                <div className="flex items-center justify-between mt-auto pt-3">
                    ...
                    <button
                        onClick={() => setOpen(true)}  // ← فقط اینجا عوض شد
